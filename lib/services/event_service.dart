...
class EventService {
  ...
  Future<String> downloadMapHolderImage(String latitude, String longitude, String eventName) async {
  ...
  Future<void> createEvent({
    ...
    try {
      ...
      String mapHolderImgUrl = await downloadMapHolderImage(latitude.toString(), longitude.toString(), eventName);
  ...
  Future<void> updateEvent(String eventId, Map<String, dynamic> updatedData) async {
    try {
      ...
      String eventName = (await FirebaseFirestore.instance.collection('events').doc(eventId).get()).get('eventName');
      if (updatedData.containsKey('place')) {
        ...
        await FirebaseFirestore.instance.collection('events').doc(eventId).update({'mapHolderImgUrl': mapHolderImgUrl});
      }
